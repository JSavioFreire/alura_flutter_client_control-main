...
class _ClientsPageState extends State<ClientsPage> {
  ...
  void createType(context) {
    ...
    Types listType = Provider.of(context, listen: false);
    ClientType dropdownValue = listType.types[0];
    ...
    showDialog(
        ...
        builder: (BuildContext context) {
          return AlertDialog(
                  ...
                  children: <Widget>[
                    ...
                    StatefulBuilder(
                      ...
                      return DropdownButton(
                        ...
                        items: listType.types.map((ClientType type) {
            ...
            actions: [
              Consumer<Clients>(
                builder: (BuildContext context, Clients test, Widget? widget) {
                  return TextButton(
