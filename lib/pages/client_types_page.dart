...
class _ClientTypesPageState extends State<ClientTypesPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body:
          Consumer<Types>(builder: (BuildContext context, Types value, child) {
        return ListView.builder(
          ...
          itemBuilder: (context, index) {
            return Dismissible(
              ...
              child: ListTile(
                leading: Icon(value.types[index].icon),
                title: Text(value.types[index].name),
                iconColor: Colors.deepOrange,
              ),
              onDismissed: (direction) {
                  value.removeType(index);
              },
            );
          },
        );
